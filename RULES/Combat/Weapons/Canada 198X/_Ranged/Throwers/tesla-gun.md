...
**Source:** Vanilla Weapons Expanded - Laser (Mod)
...
- **Type:** Ranged
- **Tech Level:** Ultra
- **Mod:** Vanilla Weapons Expanded - Laser


## Description

An ultratech arc lightning device capable of emitting a lightning bolt that disable electronic systems and sets enemies on fire.\n\nBy using advanced battery cells, this weapon is capable of warming up, boosting the firing speed with each consecutive shot when standing still.\n\nUsed widely by ultratech marines during mechanoid wars.