...
Shields skill (Skill Level: 1)

## Statistics

- **Coverage:** Neck, torso, arms, hands (when actively blocking)
- **Tech Level:** Medieval
- **Encumbrance:** 1
...
A wooden shield held together with a metal band. A leather strap and metal handle are also present on the back to allow for easy one-handed maneuvering during combat.
